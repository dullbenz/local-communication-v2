        ...
        >
          ...
          <!-- <li>
            <a href="#" class="connect">
              ...
              <span class="links_name">Connect</span>
            </a>
          ...
          >
            <li>
              <a
                :href="menuItem.link"
                :class="{
                  active: activeElement === menuItem.peerId 
                    || (activeElement === '' && menuItem.type === 'connect')
                }"
                @click.prevent="$emit(menuItem.emit, menuItem.peerId)"
              >
                <i
                  class="bx"
